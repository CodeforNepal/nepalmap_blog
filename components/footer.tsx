          ...
          >
            <div className="md:hidden">
              <button
                ...
                className="uppercase text-xs font-bold tracking-wider text-c4n-blue focus:outline-none border-t border-white py-4 w-full text-left"
                type="button"
              >
            ...
            <a
              className="uppercase text-xs font-bold tracking-wider text-c4n-blue hidden md:block"
              href="#"
            >
              Lorem ipsum dolor sit amet consectetur adipiscing elit maecenas
              mattis
